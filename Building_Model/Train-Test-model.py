...
selected_data=stock_price_data.select([' Open', ' High', ' Low', ' Close/Last'])
#print(selected_data)
...
vector_df = vector_df.select(['features', ' Close/Last'])
#print(vector_df)
...
LinearRegressor = LinearRegression(featuresCol = 'features', labelCol=' Close/Last',
